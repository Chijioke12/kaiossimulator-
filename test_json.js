...
async function doHawk() {
    ...
    const targetUrl = "https://api.kaiostech.com/kc_ksfe/v1.0/apps?bookmark=false&imei=123456789012345&os=2.5.4&page_size=2&page_num=1&mnc=0&mcc=0&category=10";
    ...
    const req = https.request(targetUrl, {
        ...
        res.on('end', () => {
            ...
            zlib.gunzip(buffer, (err, decoded) => {
                ...
                console.log(JSON.stringify(obj.apps[0], null, 2));
            });
        });
    });
    req.end();
